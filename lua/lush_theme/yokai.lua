...
local theme = lush(function()
  return {
    ...
    DiffChange   { bg = C.warn.mix(Normal.bg, 40).lighten(20).desaturate(50), fg = Normal.bg }, -- Diff mode: Changed line |diff.txt|
    DiffAdd      { bg = C.message.mix(Normal.bg, 10).lighten(20).desaturate(50), fg = DiffChange.fg }, -- Diff mode: Added line |diff.txt|
    DiffDelete   { bg = C.err.mix(Normal.bg, 30).lighten(20).desaturate(50), fg = DiffChange.fg }, -- Diff mode: Deleted line |diff.txt|
